angular.module('App').controller('AppCtrl', ['$scope', '$log', '$ionicSlideBoxDelegate', '$ionicPlatform', '$ionicModal', 'Auth', function($scope, $log, $ionicSlideBoxDelegate, $ionicPlatform, $ionicModal, Auth) {
