angular.module('dish').controller('AppCtrl', ['$scope', '$log', '$ionicSlideBoxDelegate', '$ionicPlatform', '$ionicModal', 'Auth', 'FURL', 'Utils', '$firebaseObject', '$localStorage', function($scope, $log, $ionicSlideBoxDelegate, $ionicPlatform, $ionicModal, Auth, FURL, Utils, $firebaseObject, $localStorage) {
